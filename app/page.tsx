              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full max-w-3xl h-full">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-16 w-16 rounded-full bg-white overflow-hidden flex items-center justify-center text-black font-bold z-20 border-2 border-white shadow-lg">
                    <img src={IMAGE_ASSETS.profiles.james} alt="You" className="h-full w-full object-cover" />
                  </div>
                  ...
                  <div className="absolute top-1/3 left-1/4 h-10 w-10 rounded-full overflow-hidden z-10 animate-float border border-white/50 shadow-md">
                    <img
                      src={IMAGE_ASSETS.profiles.user1}
                      alt="Connection"
                  ...
                  >
                    <img
                      src={IMAGE_ASSETS.profiles.user2}
                      alt="Connection"
                      className="h-full w-full object-cover"
                    />
                  </div>
                  ...
                  >
                    <img
                      src={IMAGE_ASSETS.profiles.user3}
                      alt="Connection"
                      className="h-full w-full object-cover"
                    />
                  </div>
                  ...
                  >
                    <img
                      src={IMAGE_ASSETS.profiles.user4}
                      alt="Connection"
                      className="h-full w-full object-cover"
                    />
                  </div>
                  ...
                  >
                    <img
                      src={IMAGE_ASSETS.profiles.user5}
                      alt="Connection"
                      className="h-full w-full object-cover"
                    />
                  </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  ...
                  <div className="flex items-center">
                    <div className="h-12 w-12 rounded-full bg-gradient-to-br from-purple-600 to-indigo-600 mr-3 flex items-center justify-center text-sm font-bold overflow-hidden">
                      <img src={IMAGE_ASSETS.profiles.james} alt="James Davidson" className="h-full w-full object-cover" />
                    </div>
                    <div>
